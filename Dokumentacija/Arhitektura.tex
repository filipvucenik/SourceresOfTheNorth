	...
	\eject
		...
		\end{packed_item}
			...
			\begin{longtblr}[
				...
				\SetCell{LightGreen} user\_ID & BIGINT & jedinstveni identifikator korisnika \\ \hline
			...
			\begin{longtblr}[
				...
				\SetCell{LightGreen} reportID & BIGINT & jedinstveni identifikator prijave \\ \hline
				...
				\SetCell{LightBlue} userID & BIGINT & jedinstveni identifikator korisnika koji je podnio prijavu \\ \hline 
				\SetCell{LightBlue} categoryID & BIGINT & jedinstveni identifikator kategorije oštećenja \\ \hline
				\SetCell{LightBlue} group\_ReportID & BIGINT & jedinstveni identifikator prijave na koju je ova prijava nadovezana \\ \hline
			\end{longtblr}
			...
			\begin{longtblr}[
				...
				\SetCell{LightGreen} imageID & BIGINT & jedinstveni identifikator slike \\ \hline
				\SetCell{LightBlue} reportID & BIGINT & jedinstveni identifikator prijave kojoj slika pripada \\ \hline
				URL & VARCHAR & URL slike \\ \hline 
			\end{longtblr}
			
			\textbf{Category} tablica čuva podatke o kategorijama kojima oštećenje može pripadati. Tablica je povezana \textit{One-to-Many} vezom s tablicom \textit{Report} preko atributa \textit{categoryID}, \textit{Many-to-One} vezom s tablicom \textit{CityOffice} preko atributa \textit{city\_OfficeID} i \textit{One-to-Many} vezom s tablicom \textit{CategoryKeywords} preko atributa \textit{categoryID}.
			...
			\begin{longtblr}[
				...
				\SetCell{LightGreen} categoryID & BIGINT & jedinstveni identifikator kategorije \\ \hline
				category\_Name & VARCHAR & naziv kategorije \\ \hline 
				\SetCell{LightBlue} city\_OfficeID & BIGINT & jedinstveni identifikator gradskog ureda koji obrađuje prijave oštećenja iz ove kategorije \\ \hline
			\end{longtblr}
			...
			\begin{longtblr}[
				...
				\SetCell{LightGreen} keywordID & BIGINT & jedinstveni identifikator ključne riječi \\ \hline
				keyword & VARCHAR & ključna riječ \\ \hline 
				\SetCell{LightBlue} categoryID & BIGINT & jedinstveni identifikator kategorije kojoj ključna riječ pripada. \\ \hline
			\end{longtblr}
			...
			\begin{longtblr}[
				...
				\SetCell{LightGreen} groupID & BIGINT & jedinstveni identifikator grupe prijava na koju se podaci referiraju \\ \hline
			...
			\begin{longtblr}[
				...
				\SetCell{LightGreen} city\_Office\_ID & BIGINT & jedinstveni identifikator gradskog ureda \\ \hline
		...
		\section{Dijagram razreda}
			...
			\begin{figure}[H]
				\includegraphics[width=\textwidth]{slike/dijagramRazreda/controller.jpg} %veličina u odnosu na širinu linije
			...
			\begin{figure}[H]
				\includegraphics[width=\textwidth]{slike/dijagramRazreda/DAOs.jpg} %veličina u odnosu na širinu linije
			...
			\begin{figure}[H]
				\includegraphics[width=\textwidth]{slike/dijagramRazreda/EntitiesOnly.jpg} %veličina u odnosu na širinu linije
				\caption{Modeli}
