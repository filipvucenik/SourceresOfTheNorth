\chapter{Opis projektnog zadatka}
		...
		Cilj ovog projekta je razviti programsku podršku za stvaranje web aplikacije "\textit{Prijava štete}". Ideja aplikacije je ponuditi običnim građanima jednostavan i efikasan način prijave oštećenja javnih površina i cesta u gradu te dobivanje povratnih informacija o konkretnom oštećenju i njihovoj prijavi. 
