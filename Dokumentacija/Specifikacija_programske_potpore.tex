	...
	\section{Funkcionalni zahtjevi}
			...
			\begin{packed_enum}
				...
				\begin{packed_enum}
					...
					\item prijavama sa statusom na čekanju mijenjati status u u procesu rješavanja
					\item prijavama sa statusom u procesu rješavanja mijenjati status u riješena
