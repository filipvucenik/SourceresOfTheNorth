	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Dijagrami obrazaca uporabe}
					...
					\begin{figure}[H]
						\includegraphics[width=\textwidth]{slike/Funkcionalnosti_korisnika.jpg} %veličina u odnosu na širinu linije
					...
					\begin{figure}[H]
						\includegraphics[width=\textwidth]{slike/Obrada_prijava.jpg} %veličina u odnosu na širinu linije
