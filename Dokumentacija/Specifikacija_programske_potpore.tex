\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\begin{packed_item}
				...
				\item F09: mogućnost automatskog predlaganja nadovezivanja prijave na već postojeću
			...
			\subsection{Obrasci uporabe}
				...
				\begin{packed_item}
					...
					\item[] \begin{packed_enum}
						...
						\item Izmjenjeni podaci se spremaju u bazu podataka
					\end{packed_enum}
