\chapter*{Dodatak: Prikaz aktivnosti grupe}
		...
		\begin{figure}[H]
			\includegraphics[width=\textwidth]{slike/dijagramPromjena.png} %veličina u odnosu na širinu linije
			\caption{Prikaz Dijagram pregleda promjena}
			\label{fig:dijagramPromjena} %label mora biti drugaciji za svaku sliku
		\end{figure}
